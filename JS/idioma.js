const traducciones = {
    es: {
        ...
        inicio: {
            ...
            seleccionIdioma: "Selecciona el idioma",
            publicado: "¡Publicado!",
            correctamentePost: "Publicado con exito.",
            aceptar: "Aceptar",
            error: "¡Error!",
            problemaPost: "Hubo un problema al hacer la publicacion.",
            ...
            escribePost: "Escribe un titulo o lo que quieras...",
        },
        perfil: {
            titulo: "CulteX | Perfil",
            buscar: "Buscar...",
            noNotificaciones: "No tienes nuevas notificaciones.",
            perfil: "Perfil",
            bloqueados:"Bloqueados",
    ...
    en: {
        ...
        inicio: {
            ...
            seleccionIdioma: "Select the language",
            publicado: "¡Posted!",
            correctamentePost: "Posted successfully.",
            aceptar: "Accept",
            error: "¡Error!",
            problemaPost: "There was a problem with the posting.",
            ...
            escribePost: "Write a title or whatever you want...",
        },
        perfil: {
            titulo: "CulteX | Profile",
            buscar: "Search...",
            noNotificaciones: "You have no new notifications.",
            perfil: "Profile",
            bloqueados:"Blocked",
...
document.querySelectorAll('.language-option').forEach(button => {
    button.addEventListener('click', function() {
        ...
        if (window.location.pathname.includes("login")) {
            ...
            pagina = "perfil";
        } else if (window.location.pathname.includes("perfilUsuario")) {
            pagina = "perfilUsuario";
        } else if (window.location.pathname.includes("grupo")) {
            pagina = "grupo";
        } else {
